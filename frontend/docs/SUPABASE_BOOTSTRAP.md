...
6. After applying `202607160105_document_review_foundation.sql`, regenerate `frontend/src/types/database.types.ts` from that applied database before adding direct generated-type queries for document reviews.
