import { Activity, Bell, BookOpen, ClipboardCheck, FileText, FolderKanban, GraduationCap, LayoutDashboard, ListChecks, MessageSquareWarning, School, ShieldCheck, Table2, UserRoundCheck, Users } from 'lucide-react'
...
export const ROLE_NAVIGATION: Record<UserRole, NavigationItem[]> = {
  [USER_ROLES.superAdmin]: items(ROUTE_PATHS.superAdmin, [['Dashboard', '', LayoutDashboard], ['Users', 'users', Users], ['Academic Setup', 'academic-setup', School], ['Subject Allocation', 'subject-allocation', UserRoundCheck], ['Timetable', 'timetable', Table2], ['Attendance', 'attendance', ClipboardCheck], ['Department Operations', 'announcements', Bell], ['Document Assignments', 'document-review-assignments', FileText], ['Audit', 'audit', ShieldCheck], ['Reports', 'reports', ListChecks]]),
  [USER_ROLES.hod]: items(ROUTE_PATHS.hod, [['Dashboard', '', LayoutDashboard], ['Faculty Profiles', 'faculty-profiles', Users], ['Academic Setup', 'academic-setup', School], ['Subject Allocation', 'subject-allocation', UserRoundCheck], ['Timetable', 'timetable', Table2], ['Attendance', 'attendance', ClipboardCheck], ['Marks', 'marks', GraduationCap], ['Requests', 'requests', FileText], ['Document Assignments', 'document-review-assignments', UserRoundCheck], ['Portion Progress', 'portion-progress', Activity], ['Department Operations', 'announcements', Bell], ['Audit', 'audit', ShieldCheck], ['Reports', 'reports', ListChecks]]),
